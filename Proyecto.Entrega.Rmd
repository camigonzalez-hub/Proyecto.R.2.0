...
Además, elegimos el dataset “Universidades – egresados” del proyecto Argentina en datos (Chequeado) porque ofrece información clara sobre cuántas personas lograron finalizar sus estudios universitarios en Argentina hasta el año 2020. Al estar organizado por institución y tipo de gestión, permite observar diferencias entre universidades y regiones del país. Es una herramienta valiosa para reflexionar sobre cómo se distribuyen las oportunidades de egreso, entendiendo que cada número representa una historia atravesada por contextos muy distintos.
...
``` {r Camila_gonzalez6 , warning=FALSE , message= FALSE,echo=FALSE}
...
```{r luciana_reinscriptos, message=FALSE, warning=FALSE,echo=FALSE}
...
```{r cargar-cuadro, echo=FALSE, message=FALSE, warning=FALSE,echo=FALSE}
# Cargar paquetes
library(readr)
library(knitr)
library(kableExtra)
...
``` {r madres_/graduados, message=FALSE, warning=FALSE,echo=FALSE}
...
``` {r padres_/graduados, message=FALSE, warning=FALSE,echo=FALSE}
...
``` {r comparación, message=FALSE, warning=FALSE,echo=FALSE}
library(readxl)
library(dplyr)
library(tidyr)
